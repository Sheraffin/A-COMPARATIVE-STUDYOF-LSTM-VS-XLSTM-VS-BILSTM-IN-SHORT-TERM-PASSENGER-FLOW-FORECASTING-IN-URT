# -*- coding: utf-8 -*-
"""Copy of BiLSTM_10mins.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1AsXzLlw36dZCbPOYrS_S4GjC-3eAjqcJ
"""
...
# Ensure compatibility with GPU memory growth
...
def multi_input_model(time_lag):
    ...
    x4 = Bidirectional(LSTM(128, return_sequences=True, input_shape=(276, 1)))(x4)  # BiLSTM layer
    x4 = Bidirectional(LSTM(276, return_sequences=False))(x4)  # BiLSTM layer
    x4 = Dense(276)(x4)
...
Run_epoch = 50  # First training 50 epochs, then add 10 epochs every time, run 15 times
for i in range(15):
